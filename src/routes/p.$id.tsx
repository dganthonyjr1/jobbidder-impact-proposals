        ...
        <div className="mb-10">
          ...
          {proposal.job_address && (
            <p className="text-muted-foreground mt-2">
              {proposal.job_address}{proposal.job_address2 ? `, ${proposal.job_address2}` : ""}{proposal.job_city ? `, ${proposal.job_city}` : ""}{proposal.job_state ? ` ${proposal.job_state}` : ""}{proposal.job_zip ? ` ${proposal.job_zip}` : ""}
            </p>
          )}
        </div>
