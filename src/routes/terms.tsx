...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — Jobbidder" },
      { name: "description", content: "Jobbidder Terms of Service for contractors, proposal recipients, and platform users." },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 rounded-lg border border-border/60 bg-card/60 p-5 text-sm leading-relaxed text-muted-foreground">
          These Terms of Service govern access to and use of Jobbidder, including the website, application, proposal pages,
        ...
        <div className="mt-10 space-y-8">
          <Section title="1. Acceptance of Terms">
            <p>
              ...
              otherwise using Jobbidder, you agree to these Terms. If you are using Jobbidder on behalf of a company or
          ...
          <Section title="2. Service Description">
            <p>
              Jobbidder provides software tools that help contractors create, manage, send, and track proposals and estimates.
            ...
            <p>
              Jobbidder is a software platform only. Jobbidder does not perform contracting work, inspect job sites, verify
          ...
          <Section title="4. Customer and Proposal Recipient Responsibilities">
            <p>
              ...
              before accepting any proposal. Acceptance of a proposal through Jobbidder is an agreement between the contractor
              and the customer, not with Jobbidder. Jobbidder is not responsible for the contractor&apos;s work, workmanship,
          ...
          <Section title="5. AI-Generated Content">
            <p>
              Jobbidder may use artificial intelligence and automated systems to help generate drafts of scopes of work,
              ...
              review and approve AI-generated content before use. Jobbidder does not warrant that AI output will be correct,
          ...
          <Section title="6. Photos, Videos, and Uploaded Content">
            ...
            <p>
              ...
              rights. Jobbidder may remove or restrict access to uploaded content if it appears to violate these Terms, creates
              security risk, or may expose Jobbidder or its users to liability.
            </p>
          </Section>

          <Section title="7. Communications, Email, and SMS">
            <p>
              Jobbidder may allow contractors to send transactional emails, proposal links, estimate links, SMS messages,
              reminders, and related customer communications. Contractors are responsible for ensuring they have appropriate
              consent and lawful authority to contact each recipient. Contractors may not use Jobbidder to send spam, unsolicited
            ...
            <p>
              ...
              provided. Jobbidder may suspend messaging features if abuse, excessive complaints, carrier violations, or unlawful
          ...
          <Section title="8. Accounts and Security">
            <p>
              ...
              You must notify Jobbidder if you believe your account has been compromised.
            </p>
          </Section>

          <Section title="9. Acceptable Use">
            <p>
              You agree not to misuse Jobbidder. Prohibited uses include attempting to disrupt the Service, reverse engineer
              ...
              communications, or use Jobbidder in a way that harms contractors, customers, third-party providers, or the platform.
            </p>
          </Section>

          <Section title="10. Third-Party Services">
            <p>
              Jobbidder relies on third-party services for hosting, database, authentication, storage, communications, voice
              ...
              services are not controlled by Jobbidder, and their availability, functionality, terms, and policies may affect the
              Service.
            </p>
          </Section>
          ...
          <Section title="12. Intellectual Property">
            <p>
              Jobbidder and its software, design, trademarks, workflows, templates, and platform content are owned by Jobbidder or
              its licensors. Contractors retain ownership of their business information, customer information, uploaded media, and
              proposal content, subject to the license needed for Jobbidder to operate the Service. You grant Jobbidder a limited
          ...
          <Section title="13. Confidentiality and Data">
            <p>
              Jobbidder will use reasonable efforts to protect non-public contractor and customer information. Contractors are
              responsible for deciding what information to enter into the Service and for avoiding unnecessary sensitive data.
              Jobbidder&apos;s handling of personal information is described in the Privacy Policy.
            </p>
          </Section>

          <Section title="14. Service Availability and Changes">
            <p>
              Jobbidder may update, modify, suspend, or discontinue parts of the Service at any time. The Service may be
              unavailable because of maintenance, outages, third-party provider failures, security events, or other causes.
              Jobbidder does not guarantee uninterrupted or error-free operation.
            </p>
          </Section>
          ...
          <Section title="15. Disclaimers">
            <p>
              ...
              Jobbidder disclaims all warranties, whether express, implied, statutory, or otherwise, including warranties of
          ...
          <Section title="16. Limitation of Liability">
            <p>
              To the maximum extent permitted by law, Jobbidder will not be liable for indirect, incidental, special,
              consequential, exemplary, or punitive damages, lost profits, lost revenue, lost business opportunities, loss of
              goodwill, data loss, or service interruption. To the maximum extent permitted by law, Jobbidder&apos;s total liability
              for any claim will not exceed the amount paid by you to Jobbidder for the Service during the twelve months before
          ...
          <Section title="17. Indemnification">
            <p>
              You agree to defend, indemnify, and hold harmless Jobbidder from claims, damages, liabilities, costs, and expenses
          ...
          <Section title="18. Suspension and Termination">
            <p>
              Jobbidder may suspend or terminate access to the Service if you violate these Terms, create security or legal risk,
              fail to pay applicable fees, misuse communications features, or use the Service in a way that may harm Jobbidder,
          ...
          <Section title="19. Governing Law">
            <p>
              These Terms are governed by the laws of the United States and the applicable state law designated by Jobbidder,
          ...
          <Section title="20. Changes to These Terms">
            <p>
              Jobbidder may update these Terms from time to time. The updated version will be posted with a new effective date.
