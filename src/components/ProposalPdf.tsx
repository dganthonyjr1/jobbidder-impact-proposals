    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        ...
        <View>
          ...
          {proposal.job_address ? <Text style={styles.address}>{proposal.job_address}{proposal.job_address2 ? `, ${proposal.job_address2}` : ""}{proposal.job_city ? `, ${proposal.job_city}` : ""}{proposal.job_state ? ` ${proposal.job_state}` : ""}{proposal.job_zip ? ` ${proposal.job_zip}` : ""}</Text> : null}
