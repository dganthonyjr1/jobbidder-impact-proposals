...
const en: Dict = {
  ...
  jobPhotos: "Job site photos",
  jobPhotosHint: "Add up to 8 photos. Appears on the PDF and the client gallery.",
  saving: "Saving…",
  materials: "Materials",
  labor: "Labor",
  item: "Item",
...
const es: Dict = {
  ...
  jobPhotos: "Fotos del sitio de trabajo",
  jobPhotosHint: "Agrega hasta 8 fotos. Aparecen en el PDF y en la galería del cliente.",
  saving: "Guardando…",
...
const fr: Dict = {
  ...
  jobPhotos: "Photos du chantier",
  jobPhotosHint: "Ajoutez jusqu'à 8 photos. Apparaissent sur le PDF et la galerie client.",
...
const pt: Dict = {
  ...
  jobPhotos: "Fotos do local",
  jobPhotosHint: "Adicione até 8 fotos. Aparecem no PDF e na galeria do cliente.",
  saving: "Salvando…",
  materials: "Materiais",
  labor: "Mão de obra",
  item: "Item",
...
const ht: Dict = {
  ...
  jobPhotos: "Foto sou plas travay la",
  jobPhotosHint: "Ajoute jiska 8 foto. Yo parèt nan PDF la ak galeri kliyan an.",
  saving: "K ap sove…",
  materials: "Materyo",
  labor: "Men-dèv",
  item: "Atik",
