...
const en: Dict = {
  ...
  hours: "Hours",
  rate: "Rate",
  savingsLine: (a) => `You save ${a} vs. retail thanks to Jobbidder wholesale pricing.`,
  tax: (p) => `Tax (${p})`,
  timeline: "Timeline",
  warranty: "Warranty",
  payment: "Payment",
...
const es: Dict = {
  ...
  hours: "Horas",
  rate: "Tarifa",
  savingsLine: (a) => `Ahorras ${a} vs. precio de menudeo gracias a los precios mayoristas de Jobbidder.`,
  tax: (p) => `Impuesto (${p})`,
  timeline: "Cronograma",
  warranty: "Garantía",
  payment: "Pago",
...
const fr: Dict = {
  ...
  hours: "Heures",
  rate: "Taux",
  savingsLine: (a) => `Vous économisez ${a} vs. prix de détail grâce aux prix de gros de Jobbidder.`,
  tax: (p) => `Taxe (${p})`,
  timeline: "Calendrier",
  warranty: "Garantie",
  payment: "Paiement",
...
const pt: Dict = {
  ...
  hours: "Horas",
  rate: "Taxa",
  savingsLine: (a) => `Você economiza ${a} vs. varejo graças aos preços de atacado da Jobbidder.`,
  tax: (p) => `Imposto (${p})`,
  timeline: "Cronograma",
  warranty: "Garantia",
  payment: "Pagamento",
...
const ht: Dict = {
  ...
  hours: "Èdtan",
  rate: "To",
  savingsLine: (a) => `Ou ekonomize ${a} vs. pri detay gras a pri an gwo Jobbidder.`,
  tax: (p) => `Taks (${p})`,
  timeline: "Orè",
  warranty: "Garanti",
  payment: "Peman",
